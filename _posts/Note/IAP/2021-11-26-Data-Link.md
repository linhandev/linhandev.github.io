...
1. 点对点网络
  - PPP
  ![ppp-frame](/assets/img/post/2021-11-26-Data-Link/ppp-frame.png)
  - 两类帧
...
2. 广播网络
  ...
  - Carrier Sense Multiple Access/Collision Avoidance (CSMA/CA)
    - IEEE 802.11 Wlan：无线一些情况下无法检测冲突，因此要避免冲突
      ![hidden-exposed-terminal](/assets/img/post/2021-11-26-Data-Link/hidden-exposed-terminal.png)
      - Hidden terminal：(a)中Host A无法知道Host C正在通信，导致冲突
      - Exposed terminal：(b)中Host C以为信道忙，等着不通信，其实这个时候可以和D通信
    - 两种模式
      ![wlan-modes](/assets/img/post/2021-11-26-Data-Link/wlan-modes.png)
      - Infrastructure mode：固定AP，大家都和路由器通信。换ap有专门的hand off方法
      - ad-hoc mode：host可以组网，转发数据
    - 工作过程
      ![csma-ca](/assets/img/post/2021-11-26-Data-Link/csma-ca.png)
...
![arp-format](/assets/img/post/2021-11-26-Data-Link/arp-format.png)
...
![proxy-arp](/assets/img/post/2021-11-26-Data-Link/proxy-arp.png)
...
![icmp unrechable](/assets/img/post/2021-11-26-Data-Link/icmp-unrechable.png)

## Bridge
![bridge](/assets/img/post/2021-11-26-Data-Link/bridge.png)
...
![address-learning](/assets/img/post/2021-11-26-Data-Link/address-learning.png)
...
![broadcast-storm](/assets/img/post/2021-11-26-Data-Link/broadcast-storm.png)
...
![stp-topo](/assets/img/post/2021-11-26-Data-Link/stp-topo.png)
...
![bpdu-format](/assets/img/post/2021-11-26-Data-Link/bpdu-format.png)
