...
![ip-example](/assets/img/post/2021-11-28-Network-Layer/ip-example.png)

![iptv-example](/assets/img/post/2021-11-28-Network-Layer/iptv-example.png)
...
![interface](/assets/img/post/2021-11-28-Network-Layer/interface.png)

### Classful IP

![ip-range](/assets/img/post/2021-11-28-Network-Layer/ip-range.png)

![classful-ip](/assets/img/post/2021-11-28-Network-Layer/classful-ip.png)
...
![special ip](/assets/img/post/2021-11-28-Network-Layer/special-ip.png)
...
![allocate subnet](/assets/img/post/2021-11-28-Network-Layer/allocate-subnet.png)
...
![routing-table](/assets/img/post/2021-11-28-Network-Layer/routing-table.png)
...
### ICMP
![icmp-format](/assets/img/post/2021-11-28-Network-Layer/icmp-format.png)
...
![icmp-redirect](/assets/img/post/2021-11-28-Network-Layer/icmp-redirect.png)
...
![icmp-redirect-format](/assets/img/post/2021-11-28-Network-Layer/icmp-redirect-format.png)
...
![icmp-router-advertisement](/assets/img/post/2021-11-28-Network-Layer/icmp-router-advertisement.png)
...
- traffic
  ...
  ![oscillations](/assets/img/post/2021-11-28-Network-Layer/oscillations.png)
- communication cost
...
![rip-v1-format](/assets/img/post/2021-11-28-Network-Layer/rip-v1-format.png)

![rip-v2-format](/assets/img/post/2021-11-28-Network-Layer/rip-v2-format.png)
...
![rip-process](/assets/img/post/2021-11-28-Network-Layer/rip-process.png)

Count to Infinity

![count-to-infinity](/assets/img/post/2021-11-28-Network-Layer/count-to-infinity.png)
...
![OSPF-hierarchy](/assets/img/post/2021-11-28-Network-Layer/ospf-hierarchy.png)
...
![OSPF-frame](/assets/img/post/2021-11-28-Network-Layer/ospf-frame.png)
...
![dij-1](/assets/img/post/2021-11-28-Network-Layer/dij-1.png)

![dij-2](/assets/img/post/2021-11-28-Network-Layer/dij-2.png)

![dij-3](/assets/img/post/2021-11-28-Network-Layer/dij-3.png)

![dij-4](/assets/img/post/2021-11-28-Network-Layer/dij-4.png)

![dij-5](/assets/img/post/2021-11-28-Network-Layer/dij-5.png)

![dij-6](/assets/img/post/2021-11-28-Network-Layer/dij-6.png)

![dij-7](/assets/img/post/2021-11-28-Network-Layer/dij-7.png)

![dij-8](/assets/img/post/2021-11-28-Network-Layer/dij-8.png)

![dij-9](/assets/img/post/2021-11-28-Network-Layer/dij-9.png)
...
- 两部分
  - External BGP：学习到其他AS的路径
    - 交换信息
    ![bgp-exchange](/assets/img/post/2021-11-28-Network-Layer/bgp-exchange.png)
      - 目标网络
      - 经过的AS
    - 政策
      - 告诉其他路由器什么
...
![traceroute-proces](/assets/img/post/2021-11-28-Network-Layer/traceroute-process.png)
...
![tftp frame format](/assets/img/post/2021-11-28-Network-Layer/tftp-frame-format.png)

![tftp process](/assets/img/post/2021-11-28-Network-Layer/tftp-process.png)
一块数据一个ack
...
![tcp format](/assets/img/post/2021-11-28-Network-Layer/tcp-format.png)
...
![tcp state](/assets/img/post/2021-11-28-Network-Layer/tcp-state.png)
...
- 面向连接，可靠
  - 错误控制：每个数据包要ack，丢失或出错重发
    ...
    - 丢失：Retransmission Timer timeout重发
      ...
      ![rtt rto](/assets/img/post/2021-11-28-Network-Layer/rtt-rto.png)
...
![tcp connection](/assets/img/post/2021-11-28-Network-Layer/tcp-connection.png)
...
![terminate without timewait](/assets/img/post/2021-11-28-Network-Layer/terminate-without-timewait.png)
- 出现问题需要断开用RST flag
...
- 反馈
  ...
  - 收到反馈
    ...
    ![rwnd](/assets/img/post/2021-11-28-Network-Layer/rwnd.png)
    - 路由器反馈丢包，可以建议发送速度
      - ECN（Explicit congestion notification）
      ![ecn](/assets/img/post/2021-11-28-Network-Layer/ecn.png)
      _ecn_
- 参数
  - 接收方
...
- 过程
![tcp congestion control](/assets/img/post/2021-11-28-Network-Layer/tcp-congestion-control.png)
  - 初始状态
    - ssthresh = 65535
    - cwnd = MSS
  - slow start & congestion avoidance：每次收到ACK
    - 当 cwnd < ssthresh：cwnd = cwnd + MSS
    - 当 cwnd > ssthresh：![cwnd over ssthresh](/assets/img/post/2021-11-28-Network-Layer/cwnd-over-ssthresh.png)
...
![congestion control](/assets/img/post/2021-11-28-Network-Layer/congestion-control.png)


交互式数据流
- 用于telnet，ssh这种
- 过程
![tcp interactive](/assets/img/post/2021-11-28-Network-Layer/tcp-interactive.png)
  - 用户按键
  - 字符发给服务器
  - 服务器将这个字符发回来，同时ACK
...
![tfp process](/assets/img/post/2021-11-28-Network-Layer/tfp-process.png)

![FTP COMMANDS](/assets/img/post/2021-11-28-Network-Layer/ftp-commands.png)

PORT：PORT的一方想用什么端口，Server和Client都可以PORT
![ftp reply](/assets/img/post/2021-11-28-Network-Layer/ftp-reply.png)
...
![multicast](/assets/img/post/2021-11-28-Network-Layer/multicast.png)
...
- 地址：所有人都可以给组播地址发，所有IP包会发给组内所有host
  ...
  - 预留地址
  ![reseved multicast address](/assets/img/post/2021-11-28-Network-Layer/reseved-multicast-address.png)
  - ipv4 -> mac：不需要ARP
  ![multicast mac](/assets/img/post/2021-11-28-Network-Layer/multicast-mac.png)
  ![wellknown multicast](/assets/img/post/2021-11-28-Network-Layer/wellknown-multicast.png)
...
- 路由
  - 三个级别
  ![multicast routing](/assets/img/post/2021-11-28-Network-Layer/multicast-routing.png)
    - 局域网网段：IGMP
    - AS内
  ...
  - 路由树
  ![multicast tree](/assets/img/post/2021-11-28-Network-Layer/multicast-tree.png)
