...
![url-format](/assets/img/post/2021-12-04-Application-Layer/url-format.png)
...
![http-request-reply](/assets/img/post/2021-12-04-Application-Layer/http-request-reply.png)

![http-request](/assets/img/post/2021-12-04-Application-Layer/http-request.png)

![http-response](/assets/img/post/2021-12-04-Application-Layer/http-response.png)
...
- start-line
  ...
  - status line
    - HTTP版本
    - 状态码
      ![http-response-code](/assets/img/post/2021-12-04-Application-Layer/http-response-code.png)
      - 1xx
      - 2xx：成功
        - 200 OK
        - 201 Created：新文件创建
...
- 非持久HTTP：HTTP 1.0 每次TCP连接最多传一个文件
  ![non-persistent-http](/assets/img/post/2021-12-04-Application-Layer/non-persistent-http.png)
  - 接收开始：请求后2RTT
  - 接收结束：2RTT+传文件时间
  - 缺点：
    - 传输前等待时间长
...
- 持久HTTP：HTTP 1.1 建立连接后先不关，顺序传多个文件
  ...
  - 缺点：
    ...
    ![hol](/assets/img/post/2021-12-04-Application-Layer/hol.png)
    - 重发过程会中断新文件传输
- HTTP/2：一个连接，数据流而不是文件
  - 数据流可以包含文件内容或头文件
  - 内容优先级
  ![https2-priority](/assets/img/post/2021-12-04-Application-Layer/https2-priority.png)
  - 缺点
    - 单个TCP连接，重发仍然中断传输
- HTTP/3：使用Quick UDP Internet Connections（QUIC），应用层协议
  - 单管道变多管道
    ...
    - 处理错误不中断传输
  - 整合传输和安全
  ![handshake](/assets/img/post/2021-12-04-Application-Layer/handshake.png)
  - 使用很多类似TCP的技术
    - 创建连接
    - 丢包的处理
    - 拥塞控制
- TCP Fast Open：握手的过程中传数据
  ![tpo-1](/assets/img/post/2021-12-04-Application-Layer/tpo-1.png)
  ![tpo-2](/assets/img/post/2021-12-04-Application-Layer/tpo-2.png)
...
## Cookie
![cookie](/assets/img/post/2021-12-04-Application-Layer/cookie.png)
...
![dhcp-process](/assets/img/post/2021-12-04-Application-Layer/dhcp-process.png)
...
![dhcp-frame-format](/assets/img/post/2021-12-04-Application-Layer/dhcp-frame-format.png)

![dhcp-config-file](/assets/img/post/2021-12-04-Application-Layer/dhcp-config-file.png)
...
![ntp-process](/assets/img/post/2021-12-04-Application-Layer/ntp-process.png)
...
![nat](/assets/img/post/2021-12-04-Application-Layer/gateway-nat-2.svg)
