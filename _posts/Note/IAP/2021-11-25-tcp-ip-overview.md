...
tags:
  ...
  - IAP
---
![internet](/assets/img/post/2021-11-25-tcp-ip-overview/internet.png)
...
![organizations](/assets/img/post/2021-11-25-tcp-ip-overview/organizations.png)
...
![osi-5](/assets/img/post/2021-11-25-tcp-ip-overview/osi-5.png)
...
![encapsulation](/assets/img/post/2021-11-25-tcp-ip-overview/encapsulation.png)
...
![linux-networking](/assets/img/post/2021-11-25-tcp-ip-overview/linux-networking.png)


设备
- hub：Level 1
  - 就是网线。一口进，其他所有口出
  - ![hub](/assets/img/post/2021-11-25-tcp-ip-overview/hub.png)
- bridge：Level 2
  - 不看高层信息，分割冲突域，可以转协议
  - 如果收发协议相同数据完全不会变
  - ![bridge](/assets/img/post/2021-11-25-tcp-ip-overview/bridge.png)
- router：Level 3
  - 路由
  - ![router](/assets/img/post/2021-11-25-tcp-ip-overview/router.png)
- switch
- gateway
...
### 域名
![domain-name](/assets/img/post/2021-11-25-tcp-ip-overview/domain-name.png)
...
![generic-domain](/assets/img/post/2021-11-25-tcp-ip-overview/generic-domain.png)

DNS分布式部署，一个服务器负责一个类型的一部分，每个服务器多地部署。查询过程
- 循环查询
![iterative-query](/assets/img/post/2021-11-25-tcp-ip-overview/iterative-query.png)
- 迭代查询
![recursive-query](/assets/img/post/2021-11-25-tcp-ip-overview/recursive-query.png)
...
![interface](/assets/img/post/2021-11-25-tcp-ip-overview/interface.png)

### Classful IP

![ip-range](/assets/img/post/2021-11-25-tcp-ip-overview/ip-range.png)

![classful-ip](/assets/img/post/2021-11-25-tcp-ip-overview/classful-ip.png)
...
路由分类
![routing-classification](/assets/img/post/2021-11-25-tcp-ip-overview/routing-classification.png)
