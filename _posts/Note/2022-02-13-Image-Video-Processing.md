...
![color](/assets/img/post/2022-02-13-Image-Video-Processing/color.png)

![eye camera](/assets/img/post/2022-02-13-Image-Video-Processing/eye-camera.png)
...
- 三元色：Trichromatic color mixing
  ...
  - CMY
    ...
    - yellow
  - XYZ
    ![xyz color](/assets/img/post/2022-02-13-Image-Video-Processing/xyz-color.png)
    - Y：亮度
    - XZ：颜色
...
- 亮度+颜色
  ...
  ![color-lhs](/assets/img/post/2022-02-13-Image-Video-Processing/color-lhs.png)
  - CIELAB
  ![cie rbg](/assets/img/post/2022-02-13-Image-Video-Processing/cie-rbg.png)
    - 一些颜色需要负的红
  - HSI(HSB)
  ![convert rgb hsi](/assets/img/post/2022-02-13-Image-Video-Processing/convert-rgb-hsi.png)
  - YIQ：模拟，NTSC(National Television System
Committee)美国标准
    - Y亮度
    - IQ颜色
    ![yiq rgb](/assets/img/post/2022-02-13-Image-Video-Processing/yiq-rgb.png)
    - 模拟彩电颜色标准，黑白电视只放YIQ里的Y
  - YUV：模拟，PAL欧洲标准
  - YCbCr：数字版YUV
    - 很多压缩图像用这个格式
    - RBG->Y：彩色变黑白
  ![ycvcr rgb](/assets/img/post/2022-02-13-Image-Video-Processing/ycvcr-rgb.png)
...
![color sensor](/assets/img/post/2022-02-13-Image-Video-Processing/color-sensor.png)

![color capture process](/assets/img/post/2022-02-13-Image-Video-Processing/color-capture-process.png)
4：demosaic
...
![contrast](/assets/img/post/2022-02-13-Image-Video-Processing/contrast.png)

直方图只能总结图像强度分布，很不一样的图片也可以有一样的直方图

![histogram](/assets/img/post/2022-02-13-Image-Video-Processing/histogram.png)

## 增强对比度
逐个像素改变强度值，函数非递减
- 固定函数
  - 线性拉伸
  ![linear stretching](/assets/img/post/2022-02-13-Image-Video-Processing/linear-stretching.png)
    - 分段线性
    ![piece wise linear](/assets/img/post/2022-02-13-Image-Video-Processing/piece-wise-linear.png)
  - 非线性拉伸
    - Log变换：往上弯，拉伸暗区域
      - g = blog(af+1)
      ![log transform](/assets/img/post/2022-02-13-Image-Video-Processing/log-transform.png)
    - 指数变换：往下弯，拉伸亮区域
      - $g = b(e^{af}-1)$
    - 指数变换，Power law
      - 只能拉伸一头，集中中间的处理不了
      ![power low](/assets/img/post/2022-02-13-Image-Video-Processing/power-low.png)
      ![power law example](/assets/img/post/2022-02-13-Image-Video-Processing/power-law-example.png)

(TODO:图片power law)
- 自适应变换：根据原图和目标的直方图确定函数
  - 直方图增强
  - 原像素变成累积概率分布*最大强度，总能得到一个比较平的histogram
![cpdf](/assets/img/post/2022-02-13-Image-Video-Processing/cpdf.png)

![flat](/assets/img/post/2022-02-13-Image-Video-Processing/flat.png)

局部增强：图像整体强度分布平均，但是局部不平均，可以滑动窗口针对局部增强对比度

在一些不重叠的区域里计算变换函数
- 区域里的所有像素用这个函数
![block histogram](/assets/img/post/2022-02-13-Image-Video-Processing/block-histogram.png)
  - 区域边缘会有跳变
- 其他的位置向区域中心点距离加权平均
![adaptive histogram](/assets/img/post/2022-02-13-Image-Video-Processing/adaptive-histogram.png)
...
正变换
![forward transform](/assets/img/post/2022-02-13-Image-Video-Processing/forward-transform.png)

逆变换
![inverse transform](/assets/img/post/2022-02-13-Image-Video-Processing/inverse-transform.png)

![forier](/assets/img/post/2022-02-13-Image-Video-Processing/forier.png)

用的是 $2\pi u$ 而不是 $\omega$ ，所以没有 $\frac{1}{2\pi}$

![fourier pair](/assets/img/post/2022-02-13-Image-Video-Processing/fourier-pair.png)

时域宽，低频信号多，频域窄。时域越宽越接近常数的频率0，频域越接近冲击。频域零点在1/时域方波长度(连续是1/2时域零点，离散是1/N，离散从0开始)
![sinc](/assets/img/post/2022-02-13-Image-Video-Processing/sinc.png)

![fourier properties](/assets/img/post/2022-02-13-Image-Video-Processing/fourier-properties.png)
时域卷积，频域相乘

时域是实函数，频域性质

![real ft](/assets/img/post/2022-02-13-Image-Video-Processing/real-ft.png)

2D傅立叶

![2d ft](/assets/img/post/2022-02-13-Image-Video-Processing/2d-ft.png)

1D单位正交基底相乘得到的2D基底还是单位正交的

![2d frequendy](/assets/img/post/2022-02-13-Image-Video-Processing/2d-frequendy.png)
2D信号频率
...
![delta 2d](/assets/img/post/2022-02-13-Image-Video-Processing/delta-2d.png)

![2d ft prop](/assets/img/post/2022-02-13-Image-Video-Processing/2d-ft-prop.png)

![2d ft prop 1](/assets/img/post/2022-02-13-Image-Video-Processing/2d-ft-prop-1.png)

可分2D傅立叶：如果f(x, y)可以表示为g(x)*h(y)的形式，用g(x)傅立叶得F(u)，用h(y)傅立叶得F(v)，F(u, v)=F(u)乘F(v)

![2d seperate ft](/assets/img/post/2022-02-13-Image-Video-Processing/2d-seperate-ft.png)

![2d seperate ft 2](/assets/img/post/2022-02-13-Image-Video-Processing/2d-seperate-ft-2.png)

2D傅立叶旋转：空间可频域一起转

![2d ft rotate](/assets/img/post/2022-02-13-Image-Video-Processing/2d-ft-rotate.png)

# DSFT, DFT
![image](/assets/img/post/2022-02-13-Image-Video-Processing/154558905-18148dd9-20e4-4141-8c40-4b3f3d652b80.png)

空间内直线在dft里垂直方向会有一条亮线，用所有的频率做一条直线出来

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154559492-b0e67d8e-aba1-403b-892f-45f0a8384dbd.png)

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154559546-ce9974ad-125e-492a-9ffc-3acbd9c0632e.png)

有周期的会有亮点；亮线和图像线垂直；很规整的sinc，比较发散

# 卷积

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154561517-ac5d5d52-9aae-440e-92a9-333e2e6aad4e.png)
...
![image](/assets/img/post/2022-02-13-Image-Video-Processing/154564052-8bb8a906-f029-44d1-b060-32f0448dfa15.png)

- 图像M\*N，filter K*L，输出 M+N-1， K+L-1
- 图像M*N，filter (2k+1, 2k+1)，蓝色和橙色区域取决于padding

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154564909-a85e6421-fa64-4dc4-86c0-ff77f7274c93.png)

可分滤波器可以在x，y上单独做

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154567418-4bcd6c8a-bebd-4391-9a49-6626ef6ac10d.png)

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154567739-7750ed85-249a-44ed-92e9-657134f94244.png)

![image](/assets/img/post/2022-02-13-Image-Video-Processing/154567903-a7563d93-3f26-418e-8db5-4c38e983fc9c.png)


# 采样&插值

![sample](/assets/img/post/2022-02-13-Image-Video-Processing/sample.png)
- 采样：连续到离散
- 插值：离散到连续
...
![1d aliasing ](/assets/img/post/2022-02-13-Image-Video-Processing/1d-aliasing.png)

![2d sampling](/assets/img/post/2022-02-13-Image-Video-Processing/2d-sampling.png)

![2d aliasing](/assets/img/post/2022-02-13-Image-Video-Processing/2d-aliasing.png)

x采样率够，y采样率不够

![2d cos](/assets/img/post/2022-02-13-Image-Video-Processing/2d-cos.png)

jaggie

![image downsample](/assets/img/post/2022-02-13-Image-Video-Processing/image-downsample.png)
...
![Nyquist Filters](/assets/img/post/2022-02-13-Image-Video-Processing/nyquist-filters.png)

prefilter，sampling filter：实际图像里可能包含非常高频的信号，在采样之前先过一个截止频率 $f_c=\frac{f_s}{2}$ 的滤波器。不做prefilter可以保留更多细节，但是会有低频的纹理

![prefilter](/assets/img/post/2022-02-13-Image-Video-Processing/prefilter.png)
...
![aliasing imaging](/assets/img/post/2022-02-13-Image-Video-Processing/aliasing-imaging.png)
...
![angular frequency](/assets/img/post/2022-02-13-Image-Video-Processing/angular-frequency.png)
...
![eye spatial](/assets/img/post/2022-02-13-Image-Video-Processing/eye-spatial.png)

![eye temperal](/assets/img/post/2022-02-13-Image-Video-Processing/eye-temperal.png)
...
![cpd example](/assets/img/post/2022-02-13-Image-Video-Processing/cpd-example.png)

眼睛对亮度更敏感，4个Y不需要4个cbcr

![4210](/assets/img/post/2022-02-13-Image-Video-Processing/4210.png)


下采样周期变短，频率变高，可能会alias，下采样前先过一个half band filter，cutoff频率应该是固有频率1/4

![down half band](/assets/img/post/2022-02-13-Image-Video-Processing/down-half-band.png)

upsample：填0，卷积
![upsample process](/assets/img/post/2022-02-13-Image-Video-Processing/upsample-process.png)
$$
\begin{aligned}
...
- bilinear 双线性内插值：新值用原图里最近的四个点线性加权平均
  ![seperate bilinear](/assets/img/post/2022-02-13-Image-Video-Processing/seperate-bilinear.png)
  - 分开插值
...
![bicubic interpolation](/assets/img/post/2022-02-13-Image-Video-Processing/bicubic-interpolation.png)

上采样周期变长，频率变小，可能会引入高频信号，上采样之后过一个half band filter
![up half band](/assets/img/post/2022-02-13-Image-Video-Processing/up-half-band.png)


H hermission 转制+共扼


![typo](/assets/img/post/2022-02-13-Image-Video-Processing/typo.png)
...
![2d dct](/assets/img/post/2022-02-13-Image-Video-Processing/2d-dct.png)

2D hadamard 基底：只有0，1，没有DCT细，但是只需要做加法

![2d hadamard](/assets/img/post/2022-02-13-Image-Video-Processing/2d-hadamard.png)
...
![order](/assets/img/post/2022-02-13-Image-Video-Processing/order.png)

![variance](/assets/img/post/2022-02-13-Image-Video-Processing/variance.png)

![dct](/assets/img/post/2022-02-13-Image-Video-Processing/dct.png)
...
![transform coding](/assets/img/post/2022-02-13-Image-Video-Processing/transform-coding.png)

量化

![quantify range](/assets/img/post/2022-02-13-Image-Video-Processing/quantify-range.png)

![quantify](/assets/img/post/2022-02-13-Image-Video-Processing/quantify.png)
...
![huffman](/assets/img/post/2022-02-13-Image-Video-Processing/huffman.png)
...
- DC信号
  ...
  ![dc coding](/assets/img/post/2022-02-13-Image-Video-Processing/dc-coding.png)

- 量化
  - 低频信号量化间隔小，高频信号量化间隔大
    - 不是朝着MSE优化，是要看起来更好
    - 间隔是人看不同图片试出来的
    ![jpeg quantify](/assets/img/post/2022-02-13-Image-Video-Processing/jpeg-quantify.png)
...
原图
![img](/assets/img/post/2022-02-13-Image-Video-Processing/img.png)

DCT系数
![dct coef](/assets/img/post/2022-02-13-Image-Video-Processing/dct-coef.png)

量化结果
![quant](/assets/img/post/2022-02-13-Image-Video-Processing/quant.png)

行程长度压缩，顺序是zigzag，先右后下。不是按照行列！
![runlength](/assets/img/post/2022-02-13-Image-Video-Processing/runlength.png)

- 黑白图
  - bpp：bit pre pixel
  - 调量化间隔控制比特率
    ![jpeg bw](/assets/img/post/2022-02-13-Image-Video-Processing/jpeg-bw.png)
- 彩色
  - 可以每个channel按黑白处理
  - 一起处理
    - 转换成YCbCr
    ...
    ![ycbcr down](/assets/img/post/2022-02-13-Image-Video-Processing/ycbcr-down.png)
    ![color jpeg](/assets/img/post/2022-02-13-Image-Video-Processing/color-jpeg.png)
    - 原图3*8bpp
    ![jpeg color example](/assets/img/post/2022-02-13-Image-Video-Processing/jpeg-color-example.png)
- JPEG-LS：无损压缩或基本无损
- JPEG2000：波长变换，无损
...
![pyramid](/assets/img/post/2022-02-13-Image-Video-Processing/pyramid.png)
- 上：高斯金字塔
- 下：拉普拉斯金字塔，接近0的值很多

![pyramid process](/assets/img/post/2022-02-13-Image-Video-Processing/pyramid-process.png)
...
![pyramid blend](/assets/img/post/2022-02-13-Image-Video-Processing/pyramid-blend.png)
...
![wavelet low res](/assets/img/post/2022-02-13-Image-Video-Processing/wavelet-low-res.png)

Harr小波分析
![harr](/assets/img/post/2022-02-13-Image-Video-Processing/harr.png)
...
![wavelet filter bank](/assets/img/post/2022-02-13-Image-Video-Processing/wavelet-filter-bank.png)

![wavelet image ](/assets/img/post/2022-02-13-Image-Video-Processing/wavelet-image.png)
行列分别进行，一个阶段包含一次行一次列，出四张图。多阶段继续分析LL

![harr abcd](/assets/img/post/2022-02-13-Image-Video-Processing/harr-abcd.png)

![wavelet multistage](/assets/img/post/2022-02-13-Image-Video-Processing/wavelet-multistage.png)

![wavelet 1](/assets/img/post/2022-02-13-Image-Video-Processing/wavelet-1.png)

![wavelet mul](/assets/img/post/2022-02-13-Image-Video-Processing/wavelet-mul.png)
