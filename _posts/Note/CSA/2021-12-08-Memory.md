...
![dram](/assets/img/post/2021-12-08-Memory/dram.png)
  - row为单位进行读写，内部有cache
  - 速率
...
![dram access time](/assets/img/post/2021-12-08-Memory/dram-access-time.png)
...
![cache stucture](/assets/img/post/2021-12-08-Memory/cache-stucture.png)

e.g：64 block，每个block 16 bytes

![address divide](/assets/img/post/2021-12-08-Memory/address-divide.png)
...
![associative](/assets/img/post/2021-12-08-Memory/associative.png)

![8 entries ](/assets/img/post/2021-12-08-Memory/8-entries.png)
- 直接相联：内存一个，cache一个
- n路组相联：内存一个，cache一组（连续n个）
![set asso](/assets/img/post/2021-12-08-Memory/set-asso.png)
- 全相联：内存一个，cache所有
...
![write hit miss](/assets/img/post/2021-12-08-Memory/write-hit-miss.png)
