...
![image](/assets/img/post/2021-02-27-Self-Host/224500872-22502e87-b835-4bc3-9656-85a22d61723b.png)

之后命令行打 dietpi-ddns，在 tui 中设置。下述截图以 dynu 为例。

![image](/assets/img/post/2021-02-27-Self-Host/226203144-feabdc40-0f60-4d31-ac9f-405e2d2a7d49.png)

![image](/assets/img/post/2021-02-27-Self-Host/226203198-b4297c2a-50f1-4408-a993-c4155de44358.png)

输入域名

![image](/assets/img/post/2021-02-27-Self-Host/226203305-175ada53-91c2-4a1e-96e9-2fecb1dfdf5b.png)

输入 ddns 服务密码，这个密码可能是登录服务商的密码，不过大概率是一个专门的用于更新 ddns 记录的密码。

![image](/assets/img/post/2021-02-27-Self-Host/226203402-89358e4d-5918-488a-8cab-ffbf8ac47487.png)
...
![image](/assets/img/post/2021-02-27-Self-Host/226203709-f883c867-1f9c-423d-8ce4-86a975dba0c3.png)

新安装大概没有 certbot，确认安装。

![image](/assets/img/post/2021-02-27-Self-Host/226203866-23ce0f29-5f53-4fb6-81fe-16e209a4d59d.png)

上下选中一项，回车修改，填写自己的域名和邮箱（证书快过期的时候会收到邮件，可以随便写）。下面的 Redirect，HSTS，OCSP 都可以不改。最后 Apply

![image](/assets/img/post/2021-02-27-Self-Host/226203967-640fb6c2-ffe8-48f0-9b08-e6e635148f11.png)
