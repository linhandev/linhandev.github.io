...
![](/assets/img/posts/DL/cnn/Convolution_schematic.gif)

首先以单通道为例，描述卷积的过程。

![conv](/assets/img/posts/DL/cnn/conv.png)
...
![size](/assets/img/posts/DL/cnn/size.png)
...
![3dcnn](/assets/img/posts/DL/cnn/3dcnn.png)
...
![params](/assets/img/posts/DL/cnn/params.png)
...
### 池化层
![pooling](/assets/img/posts/DL/cnn/pooling.png)
...
## 常用网络结构
### LeNet-5
![lenet](/assets/img/posts/DL/cnn/lenet.png)
### AlexNet
![alexnet](/assets/img/posts/DL/cnn/alexnet.png)

### VGG-16
![vgg](/assets/img/posts/DL/cnn/vgg.png)

### ResNet
残差block
![residual](/assets/img/posts/DL/cnn/residual.png)

![resnet](/assets/img/posts/DL/cnn/resnet.png)

可以理解在增加更多的层时，网络总是可以通过走residual connection保持和之前一样的深度，这样网络至少不会退化
![residual-works](/assets/img/posts/DL/cnn/residual-works.png)


### Inception
googLeNet
![inception-block](/assets/img/posts/DL/cnn/inception-block.png)

算一个卷积操作的计算量，先算输出的大小，这是进行多少次对应位置相乘，之后算每次乘有多少次运算。这两个数乘在一起。
使用1×1卷积引入bottlenet layer可以降低运算量
![reduce](/assets/img/posts/DL/cnn/reduce.png)

![inception](/assets/img/posts/DL/cnn/inception.png)
...
![triplet loss](/assets/img/posts/DL/cnn/triplet-loss.png)

![triplet loss definition](/assets/img/posts/DL/cnn/triplet-loss-definition.png)
...
## 风格迁移
![transfer](/assets/img/posts/DL/cnn/transfer.png)
