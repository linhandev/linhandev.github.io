...
![log calculations](/assets/img/post/2022-02-01-algorithm/log-calculations.png)
...
![for runtime](/assets/img/post/2022-02-01-algorithm/for-runtime.png)

for 的内容执行了 N 次，但是比较执行了 N+1 次

做题基本渐进 $10^{10}$ 到 $10^{12}$ 1s

![running time](/assets/img/post/2022-02-01-algorithm/running-time.png)
...
- 大写：存在 c，n 使得大于等于/小于等于
  - $T(n)=O(f(n))$：存在$c>0，n_0\ge 0$使得对所有$n \ge n_0$，$cf(n)\ge T(n)$
    ![O](/assets/img/post/2022-02-01-algorithm/o.png)
  - $T(n)=\Omega(f(n))$：存在$c>0，n_0\ge 0$使得对所有$n \ge n_0$，$cf(n)\le T(n)$
    ![big omega](/assets/img/post/2022-02-01-algorithm/big-omega.png)
  - $T(n)=\Theta(f(n))$：存在$c_1>0，c_2>0，n_0\ge 0$使得对所有$n \ge n_0$，$c_1f(n)\le T(n) \le c_2f(n)$
    ![big theta](/assets/img/post/2022-02-01-algorithm/big-theta.png)
...
![notations](/assets/img/post/2022-02-01-algorithm/notations.png)
