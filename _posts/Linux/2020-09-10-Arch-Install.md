...
![image](/assets/img/post/2020-09-10-Arch-Install/171315041-335255a7-8c44-4b4d-86f8-c6f03b5ba055.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/139161890-baedb7c9-3080-4c44-bd33-9d514bbe4ce3.png)

之后会进到一个命令行，开头的提示符是 root@archiso，如下

![image](/assets/img/post/2020-09-10-Arch-Install/139161941-9e1e6abc-4e50-4797-b15d-8216001e2866.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/139162328-17fe7acf-ddf2-4c69-a537-e9afaba1e19d.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/139162642-68f2027f-d4cb-4e5f-9689-c36443c51323.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/155045718-cd58db21-29a2-404e-8d9c-6da3589d608a.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153557189-0d2d5652-8e60-46ba-b131-30a88af07957.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153557435-8e429654-fb00-438a-a823-20fa5acae7cb.png)

```shell
d # 之后打一个数字分区号删除它，多次执行直到提示没有分区
```

![image](/assets/img/post/2020-09-10-Arch-Install/153557471-6bd00602-e2d6-411b-8080-bf5704277e4b.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153557577-b1c4017e-2ee4-4de0-bbaf-d70669d8b47f.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153557905-270aafcc-1db9-4c6e-9831-3f16b2303940.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153557958-ae7e3ef2-4779-41fb-9842-fc2018b15c25.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153558007-fab52bfa-32a7-40b5-b5a1-850bbf366157.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153558144-8da25103-5029-4eac-973d-b8143aa35641.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/152065902-cb1b40ca-3005-48c9-9415-0cd39a9e38f4.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/153563174-7aba4e07-390e-451e-b607-33e1355a97c9.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/155220812-a00bbf82-db57-4229-86aa-509760b8f77e.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/155212372-31f34bc2-dfac-49f4-9c06-e36867f9082c.png)
...
![image](/assets/img/post/2020-09-10-Arch-Install/139164535-05d4f355-2975-4df0-a53d-99a438fee4fa.png)
...
桌面会装很多包，如果用了 btrfs，可以在安装桌面之前做一下 snapshot。详细步骤参考[这里](https://linhandev.github.io/posts/Arch-Install/#btrfs)
...
![image](/assets/img/post/2020-09-10-Arch-Install/155061233-99de26b9-e02c-41e3-ae7d-a7c2050b0723.png)
...
重启之后应该就能看到一个登陆界面，登陆进去看到桌面就是安装成功了！如果安装过程中有任何问题欢迎在下方留言。有关一些常用软件的安装在[下一篇文章](https://linhandev.github.io/posts/Arch-Setup/)中记录。
