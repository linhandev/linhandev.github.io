...
按照[hacking](https://github.com/JetBrains/kotlin/blob/master/kotlin-native/HACKING.md#developing-kotlinnative-runtime-in-clion)指导
...
2. 在kotlin项目根目录gradle.properties或local.properties中设置 kotlin.native.isNativeRuntimeDebugInfoEnabled=true，./gradlew clean，./gradlew --stop，重新出kotlin版本
3. 在应用工程中添加编译选项 -Xbinary=stripDebugInfoFromNativeLibs=false，带 --rerun-tasks 重新出包
